...
//        });
        ...
        //MainActivity.button4.setOnClickListener(this);
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        que.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                Toast.makeText(QRActivity.this, "Confirmed! Parcel data has been cleared" , Toast.LENGTH_SHORT).show();
                            }
                            @Override
                    ...
                    case DialogInterface.BUTTON_NEGATIVE:
                        Toast.makeText(QRActivity.this, "Parcel data are not cleared", Toast.LENGTH_SHORT).show();
                        openMain();
                        break;
                }
            }
